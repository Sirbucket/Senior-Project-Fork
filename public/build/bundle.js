    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			h2 = element("h2");
    			h2.textContent = "You can buy these wonderful stickers and so much more at the link below!";
    			t4 = space();
    			u = element("u");
    			u.textContent = "Nat W's Etsy Shop";
    			t6 = space();
    			div3 = element("div");
    			p = element("p");
    			p.textContent = "Kat's Contemporary Cafe | xxx-xxx-xxxx | xxx-xxx@gmail.com | 72 Tyng Rd, Tyngsboro, Massachusetts";
    			attr_dev(img0, "class", "dark svelte-1ln1pkb");
    			if (!src_url_equal(img0.src, img0_src_value = "images/stickerDark.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "cool sticker");
    			add_location(img0, file$1, 7, 12, 123);
    			attr_dev(img1, "class", "light svelte-1ln1pkb");
    			if (!src_url_equal(img1.src, img1_src_value = "images/stickerLight.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "cool sticker");
    			add_location(img1, file$1, 8, 12, 203);
    			attr_dev(img2, "class", "catgirl svelte-1ln1pkb");
    			...
    			attr_dev(div0, "class", "stickers svelte-1ln1pkb");
    			add_location(div0, file$1, 6, 8, 87);
    			attr_dev(h2, "class", "svelte-1ln1pkb");
    			add_location(h2, file$1, 12, 12, 420);
    			attr_dev(u, "class", "pink svelte-1ln1pkb");
    			attr_dev(u, "href", "https://www.etsy.com/shop/NatWDesigns?ref=seller-platform-mcnav");
    			add_location(u, file$1, 13, 12, 515);
    			attr_dev(div1, "class", "link base svelte-1ln1pkb");
    			add_location(div1, file$1, 11, 8, 383);
    			attr_dev(div2, "class", "main svelte-1ln1pkb");
    			add_location(div2, file$1, 5, 4, 59);
    			attr_dev(p, "class", "svelte-1ln1pkb");
    			add_location(p, file$1, 17, 8, 708);
    			attr_dev(div3, "class", "footer text base background svelte-1ln1pkb");
    			add_location(div3, file$1, 16, 4, 657);
    			attr_dev(section, "class", "background");
