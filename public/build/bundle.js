...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div4, "click", /*pageChange*/ ctx[6], false, false, false),
    					listen_dev(p1, "click", menuOpen, false, false, false),
    					listen_dev(img1, "click", menuOpen, false, false, false),
    					listen_dev(div5, "click", /*pageChange*/ ctx[6], false, false, false),
    					listen_dev(div6, "click", /*pageChange*/ ctx[6], false, false, false),
    					listen_dev(div8, "click", /*pageChange*/ ctx[6], false, false, false),
    					listen_dev(div9, "click", /*pageChange*/ ctx[6], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*srcHome*/ 32 && !src_url_equal(img0.src, img0_src_value = /*srcHome*/ ctx[5])) {
    				attr_dev(img0, "src", img0_src_value);
    			}

    			if (dirty & /*srcMenu*/ 16 && !src_url_equal(img1.src, img1_src_value = /*srcMenu*/ ctx[4])) {
    				attr_dev(img1, "src", img1_src_value);
    			}

    			if (dirty & /*srcFood*/ 8 && !src_url_equal(img2.src, img2_src_value = /*srcFood*/ ctx[3])) {
    				attr_dev(img2, "src", img2_src_value);
    			}

    			if (dirty & /*srcDrink*/ 4 && !src_url_equal(img3.src, img3_src_value = /*srcDrink*/ ctx[2])) {
    				attr_dev(img3, "src", img3_src_value);
    			}

    			if (dirty & /*srcCont*/ 2 && !src_url_equal(img4.src, img4_src_value = /*srcCont*/ ctx[1])) {
    				attr_dev(img4, "src", img4_src_value);
    			}

    			if (dirty & /*srcSched*/ 1 && !src_url_equal(img5.src, img5_src_value = /*srcSched*/ ctx[0])) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('iconColors' in $$props) $$invalidate(7, iconColors = $$props.iconColors);
    		if ('srcSched' in $$props) $$invalidate(0, srcSched = $$props.srcSched);
    		if ('srcCont' in $$props) $$invalidate(1, srcCont = $$props.srcCont);
    		if ('srcDrink' in $$props) $$invalidate(2, srcDrink = $$props.srcDrink);
    		if ('srcFood' in $$props) $$invalidate(3, srcFood = $$props.srcFood);
    		if ('srcMenu' in $$props) $$invalidate(4, srcMenu = $$props.srcMenu);
    		if ('srcHome' in $$props) $$invalidate(5, srcHome = $$props.srcHome);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*iconColors*/ 128) {
    			$$invalidate(5, srcHome = 'images/homeIcon' + iconColors + '.png');
    		}

    		if ($$self.$$.dirty & /*iconColors*/ 128) {
    			$$invalidate(4, srcMenu = 'images/menuIcon' + iconColors + '.png');
    		}

    		if ($$self.$$.dirty & /*iconColors*/ 128) {
    			$$invalidate(3, srcFood = 'images/foodIcon' + iconColors + '.png');
    		}

    		if ($$self.$$.dirty & /*iconColors*/ 128) {
    			$$invalidate(2, srcDrink = 'images/drinkIcon' + iconColors + '.png');
    		}

    		if ($$self.$$.dirty & /*iconColors*/ 128) {
    			$$invalidate(1, srcCont = 'images/contactIcon' + iconColors + '.png');
    		}

    		if ($$self.$$.dirty & /*iconColors*/ 128) {
    			$$invalidate(0, srcSched = 'images/scheduleIcon' + iconColors + '.png');
    		}
    	...
    	return [srcSched, srcCont, srcDrink, srcFood, srcMenu, srcHome, pageChange, iconColors];
    }
    ...
    class Dropdown extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*iconColors*/ ctx[7] === undefined && !('iconColors' in props)) {
    			console_1.warn("<Dropdown> was created without expected prop 'iconColors'");
    		}
    	}
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$5, 9, 12, 236);
    			attr_dev(p0, "class", "svelte-4spa1i");
    			add_location(p0, file$5, 10, 12, 272);
    			attr_dev(div0, "class", "about text svelte-4spa1i");
    			add_location(div0, file$5, 8, 8, 198);
    			...
    			add_location(img0, file$5, 13, 8, 523);
    			attr_dev(div1, "class", "image accent svelte-4spa1i");
    			add_location(div1, file$5, 12, 8, 487);
    			attr_dev(h21, "class", "svelte-4spa1i");
    			add_location(h21, file$5, 16, 12, 633);
    			attr_dev(p1, "class", "svelte-4spa1i");
    			add_location(p1, file$5, 17, 12, 672);
    			attr_dev(div2, "class", "help text svelte-4spa1i");
    			add_location(div2, file$5, 15, 8, 596);
    			attr_dev(div3, "class", "left base svelte-4spa1i");
    			add_location(div3, file$5, 7, 4, 165);
    			...
    			add_location(img1, file$5, 23, 8, 1017);
    			attr_dev(div4, "class", "image accent svelte-4spa1i");
    			add_location(div4, file$5, 22, 8, 981);
    			attr_dev(h22, "class", "svelte-4spa1i");
    			add_location(h22, file$5, 26, 12, 1130);
    			attr_dev(p2, "class", "svelte-4spa1i");
    			add_location(p2, file$5, 27, 12, 1162);
    			attr_dev(p3, "class", "svelte-4spa1i");
    			add_location(p3, file$5, 28, 12, 1193);
    			attr_dev(p4, "class", "svelte-4spa1i");
    			add_location(p4, file$5, 29, 12, 1238);
    			attr_dev(p5, "class", "svelte-4spa1i");
    			add_location(p5, file$5, 30, 12, 1271);
    			attr_dev(p6, "class", "svelte-4spa1i");
    			add_location(p6, file$5, 31, 12, 1309);
    			attr_dev(div5, "class", "location text svelte-4spa1i");
    			add_location(div5, file$5, 25, 8, 1089);
    			...
    			add_location(img2, file$5, 34, 8, 1396);
    			attr_dev(div6, "class", "image accent svelte-4spa1i");
    			add_location(div6, file$5, 33, 8, 1360);
    			attr_dev(div7, "class", "right base svelte-4spa1i");
    			add_location(div7, file$5, 21, 4, 947);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*srcSide*/ 1 && !src_url_equal(img3.src, img3_src_value = /*srcSide*/ ctx[0])) {
    				attr_dev(img3, "src", img3_src_value);
    			}
    		},
    		i: noop,
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*sideColor*/ 2) {
    			$$invalidate(0, srcSide = 'images/footsteps' + sideColor + '.png');
    		}
    	};
