    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "classyB button svelte-1ezko3d");
    			add_location(div0, file$8, 15, 6, 361);
    			attr_dev(div1, "id", "classy");
    			attr_dev(div1, "class", "flexy accent svelte-1ezko3d");
    			add_location(div1, file$8, 14, 4, 315);
    			attr_dev(div2, "class", "cozyB button svelte-1ezko3d");
    			add_location(div2, file$8, 18, 6, 480);
    			attr_dev(div3, "id", "cozy");
    			attr_dev(div3, "class", "flexy accent svelte-1ezko3d");
    			add_location(div3, file$8, 17, 4, 436);
    			attr_dev(div4, "class", "coolB button svelte-1ezko3d");
    			add_location(div4, file$8, 21, 6, 597);
    			attr_dev(div5, "id", "cool");
    			attr_dev(div5, "class", "flexy accent svelte-1ezko3d");
    			add_location(div5, file$8, 20, 4, 553);
    			attr_dev(div6, "class", "carefreeB button svelte-1ezko3d");
    			add_location(div6, file$8, 24, 6, 718);
    			attr_dev(div7, "id", "carefree");
    			attr_dev(div7, "class", "flexy accent svelte-1ezko3d");
    			add_location(div7, file$8, 23, 4, 670);
    			attr_dev(div8, "class", "left colorTailLeft svelte-1ezko3d");
    			add_location(div8, file$8, 27, 6, 821);
    			attr_dev(div9, "class", "right colorTailRight svelte-1ezko3d");
    			add_location(div9, file$8, 28, 6, 867);
    			attr_dev(div10, "class", "tail svelte-1ezko3d");
    			add_location(div10, file$8, 26, 4, 795);
    			attr_dev(div11, "class", "buttons svelte-1ezko3d");
    			add_location(div11, file$8, 13, 2, 288);
    			attr_dev(p, "class", "svelte-1ezko3d");
    			add_location(p, file$8, 32, 4, 963);
    			attr_dev(div12, "class", "title base svelte-1ezko3d");
    			add_location(div12, file$8, 31, 2, 933);
    			attr_dev(section, "class", "svelte-1ezko3d");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div11 = element("div");
    			attr_dev(div0, "class", "bar1 svelte-1xhwdt6");
    			add_location(div0, file$7, 26, 6, 715);
    			attr_dev(div1, "class", "bar2 svelte-1xhwdt6");
    			add_location(div1, file$7, 27, 6, 747);
    			attr_dev(div2, "class", "bar3 svelte-1xhwdt6");
    			add_location(div2, file$7, 28, 6, 779);
    			attr_dev(div3, "class", "dropdown svelte-1xhwdt6");
    			add_location(div3, file$7, 25, 2, 664);
    			attr_dev(p0, "class", "svelte-1xhwdt6");
    			add_location(p0, file$7, 32, 6, 902);
    			attr_dev(div4, "class", "home hidden svelte-1xhwdt6");
    			add_location(div4, file$7, 31, 2, 847);
    			attr_dev(p1, "class", "svelte-1xhwdt6");
    			add_location(p1, file$7, 35, 6, 967);
    			attr_dev(p2, "class", "svelte-1xhwdt6");
    			add_location(p2, file$7, 37, 10, 1058);
    			attr_dev(div5, "class", "food svelte-1xhwdt6");
    			add_location(div5, file$7, 36, 6, 1006);
    			attr_dev(p3, "class", "svelte-1xhwdt6");
    			add_location(p3, file$7, 40, 10, 1144);
    			attr_dev(div6, "class", "drink svelte-1xhwdt6");
    			add_location(div6, file$7, 39, 6, 1091);
    			attr_dev(div7, "class", "menu hidden closed svelte-1xhwdt6");
    			add_location(div7, file$7, 34, 2, 927);
    			add_location(br, file$7, 44, 16, 1253);
    			attr_dev(p4, "class", "svelte-1xhwdt6");
    			add_location(p4, file$7, 44, 6, 1243);
    			attr_dev(div8, "class", "contact hidden svelte-1xhwdt6");
    			add_location(div8, file$7, 43, 2, 1185);
    			attr_dev(p5, "class", "svelte-1xhwdt6");
    			add_location(p5, file$7, 47, 6, 1336);
    			attr_dev(div9, "class", "schedule hidden svelte-1xhwdt6");
    			add_location(div9, file$7, 46, 2, 1277);
    			attr_dev(div10, "class", "stuff accent svelte-1xhwdt6");
    			add_location(div10, file$7, 30, 2, 817);
    			attr_dev(div11, "class", "bar1 bar2 bar3 stuff svelte-1xhwdt6");
    			add_location(div11, file$7, 51, 6, 1429);
    			attr_dev(section0, "class", "ignore visible opened change svelte-1xhwdt6");
    			add_location(section0, file$7, 50, 2, 1375);
    			attr_dev(section1, "lang", "en");
    			attr_dev(section1, "class", "svelte-1xhwdt6");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-upzoi0");
    			add_location(h1, file$6, 25, 8, 644);
    			attr_dev(div, "class", "box text base svelte-upzoi0");
    			add_location(div, file$6, 24, 4, 607);
    			attr_dev(main, "class", "background svelte-upzoi0");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h20, "class", "svelte-1u5v4um");
    			add_location(h20, file$5, 8, 12, 154);
    			attr_dev(p0, "class", "svelte-1u5v4um");
    			add_location(p0, file$5, 9, 12, 190);
    			attr_dev(div0, "class", "about text svelte-1u5v4um");
    			...
    			attr_dev(img0, "class", "svelte-1u5v4um");
    			add_location(img0, file$5, 12, 8, 441);
    			attr_dev(div1, "class", "image accent svelte-1u5v4um");
    			add_location(div1, file$5, 11, 8, 405);
    			attr_dev(h21, "class", "svelte-1u5v4um");
    			add_location(h21, file$5, 15, 12, 551);
    			attr_dev(p1, "class", "svelte-1u5v4um");
    			add_location(p1, file$5, 16, 12, 590);
    			attr_dev(div2, "class", "help text svelte-1u5v4um");
    			add_location(div2, file$5, 14, 8, 514);
    			attr_dev(div3, "class", "left base svelte-1u5v4um");
    			...
    			attr_dev(img1, "class", "svelte-1u5v4um");
    			add_location(img1, file$5, 22, 8, 935);
    			attr_dev(div4, "class", "image accent svelte-1u5v4um");
    			add_location(div4, file$5, 21, 8, 899);
    			attr_dev(h22, "class", "svelte-1u5v4um");
    			add_location(h22, file$5, 25, 12, 1048);
    			attr_dev(p2, "class", "svelte-1u5v4um");
    			add_location(p2, file$5, 26, 12, 1080);
    			attr_dev(p3, "class", "svelte-1u5v4um");
    			add_location(p3, file$5, 27, 12, 1111);
    			attr_dev(p4, "class", "svelte-1u5v4um");
    			add_location(p4, file$5, 28, 12, 1156);
    			attr_dev(p5, "class", "svelte-1u5v4um");
    			add_location(p5, file$5, 29, 12, 1189);
    			attr_dev(p6, "class", "svelte-1u5v4um");
    			add_location(p6, file$5, 30, 12, 1227);
    			attr_dev(div5, "class", "location text svelte-1u5v4um");
    			...
    			attr_dev(img2, "class", "svelte-1u5v4um");
    			add_location(img2, file$5, 33, 8, 1314);
    			attr_dev(div6, "class", "image accent svelte-1u5v4um");
    			add_location(div6, file$5, 32, 8, 1278);
    			attr_dev(div7, "class", "right base svelte-1u5v4um");
    			...
    			attr_dev(img3, "class", "footsteps svelte-1u5v4um");
    			attr_dev(img3, "alt", "footsteps");
    			add_location(img3, file$5, 37, 8, 1426);
    			attr_dev(div8, "class", "righter svelte-1u5v4um");
    			add_location(div8, file$5, 36, 4, 1395);
    			attr_dev(div9, "class", "main svelte-1u5v4um");
    			add_location(div9, file$5, 5, 4, 59);
    			attr_dev(p7, "class", "svelte-1u5v4um");
    			add_location(p7, file$5, 41, 8, 1588);
    			attr_dev(div10, "class", "footer text base background svelte-1u5v4um");
    			add_location(div10, file$5, 40, 4, 1537);
    			attr_dev(section, "class", "background svelte-1u5v4um");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h20, "class", "svelte-1ecvmn8");
    			add_location(h20, file$4, 8, 16, 181);
    			attr_dev(p0, "class", "svelte-1ecvmn8");
    			add_location(p0, file$4, 9, 16, 231);
    			attr_dev(div0, "class", "cubanInfo info text svelte-1ecvmn8");
    			...
    			attr_dev(img0, "class", "cubanImg svelte-1ecvmn8");
    			add_location(img0, file$4, 13, 12, 433);
    			attr_dev(div1, "class", "img accent svelte-1ecvmn8");
    			add_location(div1, file$4, 12, 12, 395);
    			attr_dev(div2, "class", "cuban item svelte-1ecvmn8");
    			add_location(div2, file$4, 6, 8, 92);
    			attr_dev(h21, "class", "svelte-1ecvmn8");
    			add_location(h21, file$4, 18, 16, 636);
    			attr_dev(p1, "class", "svelte-1ecvmn8");
    			add_location(p1, file$4, 19, 16, 690);
    			attr_dev(div3, "class", "hamfigInfo info text svelte-1ecvmn8");
    			...
    			attr_dev(img1, "class", "hamImg svelte-1ecvmn8");
    			add_location(img1, file$4, 23, 12, 871);
    			attr_dev(div4, "class", "img accent svelte-1ecvmn8");
    			add_location(div4, file$4, 22, 12, 833);
    			attr_dev(div5, "class", "hamfig item svelte-1ecvmn8");
    			add_location(div5, file$4, 16, 8, 545);
    			attr_dev(h22, "class", "svelte-1ecvmn8");
    			add_location(h22, file$4, 28, 16, 1078);
    			attr_dev(p2, "class", "svelte-1ecvmn8");
    			add_location(p2, file$4, 29, 16, 1137);
    			attr_dev(div6, "class", "grilledInfo info text svelte-1ecvmn8");
    			...
    			attr_dev(img2, "class", "grilledImg svelte-1ecvmn8");
    			add_location(img2, file$4, 33, 12, 1298);
    			attr_dev(div7, "class", "img accent svelte-1ecvmn8");
    			add_location(div7, file$4, 32, 12, 1260);
    			attr_dev(div8, "class", "grilled item svelte-1ecvmn8");
    			add_location(div8, file$4, 26, 8, 985);
    			attr_dev(h23, "class", "svelte-1ecvmn8");
    			add_location(h23, file$4, 38, 16, 1501);
    			attr_dev(p3, "class", "svelte-1ecvmn8");
    			add_location(p3, file$4, 39, 16, 1548);
    			attr_dev(div9, "class", "soupInfo info text svelte-1ecvmn8");
    			...
    			attr_dev(img3, "class", "soupImg svelte-1ecvmn8");
    			add_location(img3, file$4, 43, 12, 1692);
    			attr_dev(div10, "class", "img accent svelte-1ecvmn8");
    			add_location(div10, file$4, 42, 12, 1654);
    			attr_dev(div11, "class", "soup item svelte-1ecvmn8");
    			add_location(div11, file$4, 36, 8, 1414);
    			attr_dev(div12, "class", "main base svelte-1ecvmn8");
    			add_location(div12, file$4, 5, 4, 59);
    			attr_dev(p4, "class", "svelte-1ecvmn8");
    			add_location(p4, file$4, 48, 8, 1847);
    			attr_dev(div13, "class", "footer text base svelte-1ecvmn8");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "chocInfo info text svelte-1ecvmn8");
    			...
    			attr_dev(img2, "class", "warmImg svelte-1ecvmn8");
    			add_location(img2, file$3, 31, 16, 1126);
    			attr_dev(div7, "class", "img accent svelte-1ecvmn8");
    			add_location(div7, file$3, 30, 12, 1084);
    			attr_dev(div8, "class", "warm item svelte-1ecvmn8");
    			add_location(div8, file$3, 24, 8, 804);
    			attr_dev(div9, "class", "main base svelte-1ecvmn8");
    			add_location(div9, file$3, 5, 4, 59);
    			attr_dev(p3, "class", "svelte-1ecvmn8");
    			add_location(p3, file$3, 36, 8, 1299);
    			attr_dev(div10, "class", "footer text base background svelte-1ecvmn8");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h20, "class", "svelte-vbdctc");
    			add_location(h20, file$2, 7, 12, 129);
    			attr_dev(p0, "class", "svelte-vbdctc");
    			add_location(p0, file$2, 8, 12, 161);
    			attr_dev(p1, "class", "svelte-vbdctc");
    			add_location(p1, file$2, 9, 12, 192);
    			attr_dev(p2, "class", "svelte-vbdctc");
    			add_location(p2, file$2, 10, 12, 237);
    			attr_dev(div0, "class", "left text base svelte-vbdctc");
    			...
    			attr_dev(img, "class", "svelte-vbdctc");
    			add_location(img, file$2, 13, 8, 317);
    			attr_dev(div1, "class", "image svelte-vbdctc");
    			add_location(div1, file$2, 12, 8, 288);
    			attr_dev(h21, "class", "svelte-vbdctc");
    			add_location(h21, file$2, 16, 12, 432);
    			attr_dev(p3, "class", "svelte-vbdctc");
    			add_location(p3, file$2, 17, 12, 470);
    			attr_dev(p4, "class", "svelte-vbdctc");
    			add_location(p4, file$2, 18, 12, 503);
    			attr_dev(div2, "class", "right text base svelte-vbdctc");
    			add_location(div2, file$2, 15, 8, 389);
    			attr_dev(div3, "class", "main svelte-vbdctc");
    			add_location(div3, file$2, 5, 4, 59);
    			attr_dev(p5, "class", "svelte-vbdctc");
    			add_location(p5, file$2, 22, 8, 612);
    			attr_dev(div4, "class", "footer text base background svelte-vbdctc");
