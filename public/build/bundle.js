    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div11 = element("div");
    			attr_dev(div0, "class", "bar1 svelte-4sod14");
    			add_location(div0, file$7, 26, 6, 721);
    			attr_dev(div1, "class", "bar2 svelte-4sod14");
    			add_location(div1, file$7, 27, 6, 753);
    			attr_dev(div2, "class", "bar3 svelte-4sod14");
    			add_location(div2, file$7, 28, 6, 785);
    			attr_dev(div3, "id", "dropdown");
    			attr_dev(div3, "class", "dropdown svelte-4sod14");
    			add_location(div3, file$7, 25, 2, 656);
    			attr_dev(p0, "class", "svelte-4sod14");
    			add_location(p0, file$7, 32, 8, 912);
    			attr_dev(div4, "class", "home hidden svelte-4sod14");
    			add_location(div4, file$7, 31, 4, 855);
    			attr_dev(p1, "class", "svelte-4sod14");
    			add_location(p1, file$7, 35, 8, 983);
    			attr_dev(p2, "class", "svelte-4sod14");
    			add_location(p2, file$7, 37, 12, 1078);
    			attr_dev(div5, "class", "food svelte-4sod14");
    			add_location(div5, file$7, 36, 8, 1024);
    			attr_dev(p3, "class", "svelte-4sod14");
    			add_location(p3, file$7, 40, 12, 1170);
    			attr_dev(div6, "class", "drink svelte-4sod14");
    			add_location(div6, file$7, 39, 8, 1115);
    			attr_dev(div7, "class", "menu hidden closed svelte-4sod14");
    			add_location(div7, file$7, 34, 4, 941);
    			add_location(br, file$7, 44, 18, 1287);
    			attr_dev(p4, "class", "svelte-4sod14");
    			add_location(p4, file$7, 44, 8, 1277);
    			attr_dev(div8, "class", "contact hidden svelte-4sod14");
    			add_location(div8, file$7, 43, 4, 1217);
    			attr_dev(p5, "class", "svelte-4sod14");
    			add_location(p5, file$7, 47, 8, 1376);
    			attr_dev(div9, "class", "schedule hidden svelte-4sod14");
    			add_location(div9, file$7, 46, 4, 1315);
    			attr_dev(div10, "class", "stuff accent svelte-4sod14");
    			add_location(div10, file$7, 30, 2, 823);
    			attr_dev(div11, "class", "bar1 bar2 bar3 stuff svelte-4sod14");
    			add_location(div11, file$7, 51, 6, 1471);
    			attr_dev(section0, "class", "ignore visible opened change svelte-4sod14");
    			add_location(section0, file$7, 50, 2, 1417);
    			attr_dev(section1, "class", "svelte-4sod14");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1yr3w1k");
    			add_location(h1, file$6, 25, 8, 644);
    			attr_dev(div, "class", "box text base svelte-1yr3w1k");
    			add_location(div, file$6, 24, 4, 607);
    			attr_dev(main, "class", "background svelte-1yr3w1k");
