    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img1, file$4, 26, 12, 1108);
    			attr_dev(div5, "class", "img accent svelte-15grk52");
    			add_location(div5, file$4, 25, 12, 1070);
    			attr_dev(div6, "class", "sliders item svelte-15grk52");
    			add_location(div6, file$4, 19, 8, 688);
    			attr_dev(h22, "class", "svelte-15grk52");
    			add_location(h22, file$4, 31, 16, 1313);
    			attr_dev(p2, "class", "svelte-15grk52");
    			add_location(p2, file$4, 32, 16, 1378);
    			attr_dev(div7, "class", "hamfigInfo info text svelte-15grk52");
    			add_location(div7, file$4, 30, 12, 1261);
    			if (!src_url_equal(img2.src, img2_src_value = "images/cuban.jpg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "Ham and fig sandwich");
    			attr_dev(img2, "class", "hamImg svelte-15grk52");
    			add_location(img2, file$4, 36, 12, 1714);
    			attr_dev(div8, "class", "img accent svelte-15grk52");
    			add_location(div8, file$4, 35, 12, 1676);
    			attr_dev(div9, "class", "cauldron item svelte-15grk52");
    			add_location(div9, file$4, 29, 8, 1220);
    			attr_dev(h11, "class", "svelte-15grk52");
    			add_location(h11, file$4, 40, 12, 1869);
    			attr_dev(div10, "class", "header text svelte-15grk52");
    			add_location(div10, file$4, 39, 8, 1830);
    			attr_dev(h23, "class", "svelte-15grk52");
    			add_location(h23, file$4, 44, 16, 1996);
    			attr_dev(p3, "class", "svelte-15grk52");
    			add_location(p3, file$4, 45, 16, 2051);
    			attr_dev(div11, "class", "soupInfo info text svelte-15grk52");
    			add_location(div11, file$4, 43, 12, 1946);
