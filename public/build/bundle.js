    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h20, "class", "svelte-s5y9f0");
    			add_location(h20, file$3, 7, 12, 129);
    			attr_dev(p0, "class", "svelte-s5y9f0");
    			add_location(p0, file$3, 8, 12, 161);
    			attr_dev(p1, "class", "svelte-s5y9f0");
    			add_location(p1, file$3, 9, 12, 192);
    			attr_dev(p2, "class", "svelte-s5y9f0");
    			add_location(p2, file$3, 10, 12, 237);
    			attr_dev(div0, "class", "left text base svelte-s5y9f0");
    			...
    			attr_dev(img, "class", "svelte-s5y9f0");
    			add_location(img, file$3, 13, 8, 324);
    			attr_dev(div1, "class", "image accent svelte-s5y9f0");
    			add_location(div1, file$3, 12, 8, 288);
    			attr_dev(h21, "class", "svelte-s5y9f0");
    			add_location(h21, file$3, 16, 12, 439);
    			attr_dev(p3, "class", "svelte-s5y9f0");
    			add_location(p3, file$3, 17, 12, 477);
    			attr_dev(p4, "class", "svelte-s5y9f0");
    			add_location(p4, file$3, 18, 12, 510);
    			attr_dev(div2, "class", "right text base svelte-s5y9f0");
    			add_location(div2, file$3, 15, 8, 396);
    			attr_dev(div3, "class", "main svelte-s5y9f0");
    			add_location(div3, file$3, 5, 4, 59);
    			attr_dev(p5, "class", "svelte-s5y9f0");
    			add_location(p5, file$3, 22, 8, 619);
    			attr_dev(div4, "class", "footer text base background svelte-s5y9f0");
    			add_location(div4, file$3, 21, 4, 568);
    			attr_dev(section, "class", "background");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p5 = element("p");
    			p5.textContent = "Kat's Contemporary Cafe | xxx-xxx-xxxx | xxx-xxx@gmail.com | 72 Tyng Rd, Tyngsboro, Massachusetts";
    			attr_dev(h20, "class", "svelte-16n18ax");
    			add_location(h20, file$2, 7, 12, 129);
    			attr_dev(p0, "class", "svelte-16n18ax");
    			add_location(p0, file$2, 8, 12, 161);
    			attr_dev(p1, "class", "svelte-16n18ax");
    			add_location(p1, file$2, 9, 12, 192);
    			attr_dev(p2, "class", "svelte-16n18ax");
    			add_location(p2, file$2, 10, 12, 237);
    			attr_dev(div0, "class", "left text base svelte-16n18ax");
    			add_location(div0, file$2, 6, 8, 87);
    			if (!src_url_equal(img.src, img_src_value = "images/logo.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Cool logo :)");
    			attr_dev(img, "class", "svelte-16n18ax");
    			add_location(img, file$2, 13, 8, 324);
    			attr_dev(div1, "class", "image accent svelte-16n18ax");
    			add_location(div1, file$2, 12, 8, 288);
    			attr_dev(h21, "class", "svelte-16n18ax");
    			add_location(h21, file$2, 16, 12, 439);
    			attr_dev(p3, "class", "svelte-16n18ax");
    			add_location(p3, file$2, 17, 12, 476);
    			attr_dev(p4, "class", "svelte-16n18ax");
    			add_location(p4, file$2, 18, 12, 518);
    			attr_dev(div2, "class", "right text base svelte-16n18ax");
    			add_location(div2, file$2, 15, 8, 396);
    			attr_dev(div3, "class", "main svelte-16n18ax");
    			add_location(div3, file$2, 5, 4, 59);
    			attr_dev(p5, "class", "svelte-16n18ax");
    			add_location(p5, file$2, 22, 8, 631);
    			attr_dev(div4, "class", "footer text base background svelte-16n18ax");
    			add_location(div4, file$2, 21, 4, 580);
    			attr_dev(section, "class", "background");
